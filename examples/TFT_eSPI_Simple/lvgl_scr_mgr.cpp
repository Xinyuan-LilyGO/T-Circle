...
void ScrMgrInit(void)
{
    ...
    ScrMgrRegScrList   = (SCR_MGR_REG_SCR_LIST_HANDLE_T*)lv_mem_alloc(sizeof(SCR_MGR_REG_SCR_LIST_HANDLE_T) + cnt * sizeof(SCR_MGR_SCR_HANDLE_T *));
...
bool ScrMgrSwitchScr(uint32_t scr_id, bool anim)
{
    ...
    stack_item            = (SCR_MGR_SCR_STACK_HANDLE_T *)lv_mem_alloc(sizeof(SCR_MGR_SCR_STACK_HANDLE_T));
